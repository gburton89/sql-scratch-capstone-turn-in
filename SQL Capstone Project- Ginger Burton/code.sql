--Count campaigns and sources, then match
...
--find unique pages that are on website
...
WITH last_touch AS (
  ...
  --SELECT and COUNT Rows WHERE last touch is
  --associated with a campaign and source
...
--COUNT DISTINCT users who made a purchase
